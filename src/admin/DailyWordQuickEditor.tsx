...
const DailyWordQuickEditor: React.FC = () => {
  ...
  return (
    <div className="p-4 space-y-4 border-b border-border-light">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-slate-soft hover:text-primary transition-colors"
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="text-xs font-bold text-slate-deep">
        ...
        <button
          ...
          className="p-1 text-slate-soft hover:text-primary hover:bg-slate-100 rounded transition-colors"
          title="Select date"
        >
      ...
      <div className="rounded-lg border border-border-light bg-slate-50 p-3 space-y-3">
        ...
        {showFull && (
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-soft uppercase">Title</label>
            <input
              type="text"
              placeholder="Today's encouragement..."
              value={formData.title}
              onChange={(e) => handleInputChange('title', e.target.value)}
              className="w-full bg-white border border-border-light rounded px-2 py-1.5 text-xs font-medium placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-primary"
              disabled={saving}
            />
          </div>
        )}
        ...
        {/* Content Textarea */}
        <div className="space-y-1">
          <label className="text-xs font-bold text-slate-soft uppercase">
          ...
          <textarea
            ...
            className="w-full bg-white border border-border-light rounded px-2 py-1.5 text-xs font-medium placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-primary resize-none"
        ...
        {showFull && (
          <>
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-soft uppercase">Scripture Reference</label>
              <input
                type="text"
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-soft uppercase">Prayer (Optional)</label>
              <textarea
        ...
        <div className="flex justify-between items-center pt-2 border-t border-slate-200 gap-2">
          <div className="flex gap-1">
            <button
              onClick={() => setShowFull(!showFull)}
              className="text-slate-soft hover:text-primary transition-colors p-1"
            ...
            {formData.postId && (
              <button
                onClick={handleClear}
                className="text-slate-soft hover:text-rose-500 transition-colors p-1"
                title="Clear"
                disabled={saving}
              >
          ...
          <div className="flex gap-2">
            <button
              ...
              className="rounded bg-slate-200 px-3 py-1.5 text-xs font-bold text-slate-700 uppercase hover:bg-slate-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {saving ? 'Saving...' : 'Save'}
            </button>

  ...
  <div className="flex flex-col lg:flex-row gap-5 items-start">
    <div className="flex-1 flex flex-col gap-5">
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 flex items-center gap-2.5">
          ...
          <h3 className="text-sm font-bold text-slate-800">Item Metadata</h3>
        </div>
    ...
    <div className="w-full lg:w-80 flex-shrink-0">
      <div className="bg-white rounded-xl border border-red-200 overflow-hidden">
        <div className="px-5 py-4 border-b border-red-100 bg-red-50/60 flex items-center gap-2.5">
          <Icon name="warning" size={18} className="text-red-500" />
          <h3 className="text-sm font-bold text-red-700">Danger Zone</h3>
        </div>
        <div className="px-5 py-5 flex flex-col gap-4">
          <div>
            <p className="text-sm font-semibold text-slate-800">Archive Item</p>
            ...
            <button
              onClick={onArchive}
              className="w-full px-4 py-2 rounded-lg border border-slate-300 text-sm font-semibold text-slate-700 bg-white hover:bg-slate-50 transition-colors flex items-center justify-center gap-2"
            >
